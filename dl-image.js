...
//매일 11:00 - 12:59 까지 1분단위로 오띠모푸드 사이트 크롤링
cron.schedule('*/1 11-12 * * *', function () {
  console.log('info', 'At every minute past every hour from 11:00 through 12:59 ' + new Date());
  //logger.log();
...
//today_crawl = "7/17";
      ...
      $("p").each(function(idx) {
        ...
        //텍스트 파일생성
        if(check_crawl){
             console.log('check_crawl--안으로-->'+check_crawl);
