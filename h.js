...
app.post('/message', function(req, res){
  ...
  if(_obj.type == "text"){
	  if(_obj.content == "오띠모푸드"){
			//ottimo_text = fs.readFileSync(__dirname+'/crawl_data/2018_7_13.txt', 'utf8');
      setToday('ottimo');
